...
export default function Navbar() {
  ...
  return (
    ...
    {/* Top Bar */}
    <div className="w-full lg:h-[45px] ex:h-[35px] flex justify-between ex:pl-[20px] ex:pr-[20px] pt-[10px] lg:pl-[100px]">
      <Image src={des} alt="" />
      <div className="lg:w-[450.81px] lg:h-[36px] lg:pt-[10px] ex:pt-[2px] lg:text-[18px] ex:text-[15px] text-[#00000098] font-semibold leading-[14px] flex lg:gap-[20px] ex:gap-[12px] lg:mr-[50px]">
        <Link href="/">Home</Link>
        <hr className="lg:w-[3px] ex:w-[2px] lg:h-[16px] ex:h-[12px] bg-[#00000060]" />
    ...
    {/* Bottom Navbar */}
    <div className="w-full lg:h-[60px] lg:px-[150px] flex mt-[12px] items-center justify-between">
      {/* Logo */}
      <Image
        src={logo}
        alt="logo"
        className="lg:w-[60px] h-[20.54px] mt-[20px] lg:flex ex:hidden"
      />
      ...
      {/* Navbar Links */}
      <div className="lg:w-[520px] lg:h-[30px] justify-between font-semibold text-[21px] leading-5 lg:flex ex:hidden lg:ml-[450px] ex:ml-[12px] mt-[19px]">
      ...
      {/* Search Bar */}
      <div className="w-[250px] hidden md:flex lg:h-[40px] ex:h-[35px] ex:ml-[60px] ex:mt-[8px] rounded-[100px] bg-[#F5F5F5] lg:mt-[10px] lg:ml-[180px] gap-[12px]">
