...
export default function Home(){
 return <div className="font-sans">
    <div className="lg:w-full ex:w-[380px] h-[5442.36px]">
       ...
       <div className="lg:w-full ex:w-[380px] h-[1000px] lg:mb-[300px]">
          ...
          <div className="w-full h-[229px] lg:mt-[45px] ex:mt-[20px] lg:text-center lg:pl-[3px] ex:pl-[10px]">
             ...
             <p className="lg:w-[511px] ex:w-[360px] h-[48px] font-normal lg:text-[18px] ex:text-[12px] lg:leading-6 ex:leading-[22px] lg:ml-[700px] lg:mt-[12px]">Extreme comfort. Hyper durable. Max volume. Introducing the Air Max Pulse—designed to push you past your limits and help you go to the max.</p>
              <div className="flex gap-[10px] lg:ml-[800px] lg:mt-[70px] ex:mt-[30px]">
       ...
       <div className="w-full h-[977px] ex:mt-[-50px] lg:mt-[50px] lg:mb-[500px]">
       ...
       <div className="lg:w-full ex:w-[380px] ex:h-[1700px] lg:h-[561px] lg:mt-[-80px] ex:mt-[-450px] lg:mb-[100px]">
         <p className="font-semibold lg:text-[32px] ex:text-[20px] leading-7 lg:ml-[48px]">Gear Up</p>
            <div className="w-full mt-[20px] lg:h-[540px] lg:mt-0 ex:mt-[280px] pl-[-20px]">
              <Latest />
            </div>
       </div>

       <div className="lg:w-full ex:w-[380px] h-[977px] mt-[50px] lg:mb-[300px]">
         <p className="font-semibold lg:text-[32px] ex:text-[20px] lg:ml-[48px] ex:ml-[7px] leading-6">Don't Miss</p>
         <Image src={pic9} alt="pics" className="lg:w-full lg:h-[1000px] ex:w-full ex:h-[210px] lg:mt-[40px] ex:mt-[10px]" />
         <div className="lg:w-full ex:w-[380px] h-[177px] lg:mt-[60px] text-center">
       ...
       <div className="lg:w-full ex:w-[380px] h-[592px] lg:mt-[500px] ex:mt-[-550px] mb-[300px]">
         <p className="font-semibold lg:text-[32px] ex:text-[20px] lg:ml-[45px] ex:ml-[7px] leading-7 lg:mb-[30px]">The Essentials</p>
         <div className="lg:w-full ex:w-[380px] ex:h-[1500px] lg:h-[540px] lg:flex lg:gap-[15px] mt-[30px]">
